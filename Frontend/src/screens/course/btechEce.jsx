...
const useTranslation = () => {
  ...
  useEffect(() => {
    const fetchTranslations = async () => {
      ...
      try {
        console.log('Fetching translations for btech-ece page:', language);
...
export default function BTechECE() {
  ...
  const { content: pageContent, blocks: contentBlocks, loading: contentLoading } = usePageContent('btech-ece');
