        ...
        <div className="mx-auto py-6 sm:py-8 md:py-10 lg:py-12">
          <div className="w-full mx-auto text-center px-4 sm:px-6 md:px-8">
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 backdrop-blur-md rounded-full text-xs sm:text-sm font-bold mb-3 sm:mb-4 border hover:scale-105 transition-all duration-500 shadow-lg cursor-pointer" style={{ backgroundColor: `${color1}1A`, color: color1, borderColor: `${color1}66` }}>
              <Cpu className="w-3.5 h-3.5 sm:w-4 sm:h-4" style={{ color: color1 }} />
              B.Tech Programme
            </div>
        ...
        <div className="w-full mx-auto space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12">
          ...
          >
            <div className="p-6 sm:p-8 md:p-10 lg:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6 lg:gap-8 mt-6 sm:mt-8">
          ...
          >
            <div className="p-6 sm:p-8 md:p-10 lg:p-12">
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5 md:mb-6">
                <div className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-2xl flex items-center justify-center shadow-md" style={{ backgroundColor: darkMode ? '#1f2937' : color2 }}>
                  <GraduationCap className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" style={{ color: color1 }} />
                </div>
                <h2 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>
                  Admission
                </h2>
              </div>
              <p className={`text-base sm:text-lg md:text-xl leading-relaxed mb-3 sm:mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
          ...
          >
            <div className="p-6 sm:p-8 md:p-10 lg:p-12">
              <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-7 md:mb-8">
                <h2 className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>
              ...
              <p className={`text-base sm:text-lg md:text-xl leading-relaxed mt-4 sm:mt-5 md:mt-6 p-4 sm:p-5 md:p-6 rounded-2xl border-2 border-dashed ${darkMode ? 'text-gray-300 bg-gray-900' : 'text-gray-700 bg-white'}`} style={{ borderColor: `${color1}66`, backgroundColor: darkMode ? 'rgba(31, 41, 55, 0.5)' : 'rgba(255, 255, 255, 0.5)' }}>
          ...
          >
            <div className="p-6 sm:p-8 md:p-10 lg:p-12">
              <h2 className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-6 sm:mb-7 md:mb-8 ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>
              ...
              <div className="mt-6 sm:mt-7 md:mt-8 space-y-3 sm:space-y-4">
                <p className={`text-base sm:text-lg md:text-xl p-3 sm:p-4 md:p-5 rounded-lg ${darkMode ? 'text-gray-300 bg-gray-900' : 'text-gray-700 bg-gray-50'}`} style={{ backgroundColor: darkMode ? 'rgba(31, 41, 55, 0.5)' : color3 }}>
          ...
          >
            <div className="p-6 sm:p-8 md:p-10 lg:p-12">
              <h3 className={`text-xl sm:text-2xl md:text-3xl font-semibold mb-4 sm:mb-5 md:mb-6 ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>
