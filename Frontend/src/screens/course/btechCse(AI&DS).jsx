...
const useTranslation = () => {
  ...
  useEffect(() => {
    const fetchTranslations = async () => {
      ...
      try {
        console.log('Fetching translations for btech-ai-ds page:', language);
...
export default function BTechCseAI_DS() {
  ...
  const { content: pageContent, blocks: contentBlocks, loading: contentLoading } = usePageContent('btech-ai-ds');
