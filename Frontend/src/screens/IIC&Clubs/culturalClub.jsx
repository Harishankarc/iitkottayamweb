        ...
        {contentBlocks
          ...
          .map((block, index) => {
            ...
            switch (blockType) {
              case 'paragraph':
                return (
                  <div key={blockKey} className={`mb-12 p-8 rounded-2xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 ${darkMode ? 'bg-gray-800 hover:bg-gray-750' : 'bg-white hover:bg-gray-50'} shadow-xl border-2 hover:border-opacity-100`} 
                ...
                return (
                  <div key={blockKey} className="mb-12">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {(Array.isArray(block.content?.items) ? block.content.items : []).map((item, itemIndex) => (
                        <div
                          key={itemIndex}
