...
export default function ACM() {
  ...
  const aboutBlock = contentBlocks.find(b => b.blockId === 'acm-about' || b.blockType === 'paragraph' && b.sectionName === 'about');
  const activitiesBlock = contentBlocks.find(b => b.blockId === 'acm-activities' || b.blockType === 'list' && b.sectionName === 'activities');
  const coordinatorsBlock = contentBlocks.find(b => b.blockId === 'acm-coordinators' || b.sectionName === 'coordinators');
  const membersBlock = contentBlocks.find(b => b.blockId === 'acm-members' || b.sectionName === 'members');
