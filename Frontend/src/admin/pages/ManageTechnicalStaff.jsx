...
export default function ManageTechnicalStaff() {
  ...
  const [settingsData, setSettingsData] = useState({
    ...
    description: 'Expert technicians maintaining and supporting our institution\'s technological infrastructure.'
  });
  ...
  const fetchSettings = async () => {
    try {
      ...
      setSettingsData({
        ...
        description: descRes.data?.settingValue || 'Expert technicians maintaining and supporting our institution\'s technological infrastructure.'
      });
    } catch (error) {
    ...
    try {
      const results = await Promise.all([
        ...
        API.fetchWithRetry(`${API.baseURL}/api/site-settings`, {
          ...
          headers: API.getAuthHeaders(),
          body: JSON.stringify({
            settingKey: 'technical_description',
