...
import { supportStaffData } from '../../data/peopleData';

export default function ManageSupportStaff() {
  ...
  const fetchPeople = async () => {
    try {
      ...
      const hardcodedWithIds = supportStaffData.map((item, index) => ({
        ...item,
        id: -(index + 1),
        isActive: true,
        isHardcoded: true
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b">
              <h2 className="text-xl font-bold">{editingItem ? 'Edit Support Staff' : 'Add Support Staff'}</h2>
            </div>
