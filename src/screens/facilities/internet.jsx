  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {/* Key Features Grid */}
        <div className="max-w-5xl mx-auto mb-12 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div 
            className={`rounded-2xl overflow-hidden shadow-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} transition-all duration-300 border-2`}
            style={{
              borderColor: darkMode ? '#374151' : `${color1}33`
            }}
            onMouseEnter={(e) => e.currentTarget.style.borderColor = color1}
