  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <div className={`relative overflow-hidden w-full ${darkMode ? 'bg-gray-800' : 'bg-white'}`} style={{ height: '60vh' }}>
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="max-w-5xl mx-auto text-center px-4">
            ...
            <h1 className={`text-5xl md:text-6xl lg:text-7xl font-extrabold mb-8 leading-tight tracking-tight ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>
              Hostel
            </h1>
            <p className={`text-m md:text-l lg:text-xl leading-relaxed font-light max-w-4xl mx-auto ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
      ...
      <div className="container mx-auto px-4 py-12">
        {/* Hostel Description */}
        <div className={`max-w-5xl mx-auto mb-12 p-8 rounded-2xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-xl`}>
        ...
        {/* Hostel Rules Link */}
        <div className={`max-w-5xl mx-auto mb-12 p-6 rounded-2xl text-center ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-xl`}>
