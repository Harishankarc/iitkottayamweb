          ...
          <div className="relative container mx-auto px-4 py-28 md:py-36">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold text-gray-900 mb-8 leading-tight tracking-tight">
                About <span className="block md:inline text-transparent bg-clip-text" style={{ backgroundImage: `linear-gradient(to right, ${color1}, ${color1}B3)` }}>IIIT Kottayam</span>
              </h1>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <section className="mb-24">
            <div className="max-w-7xl mx-auto">
              <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-2xl hover:bg-[#e8f5f0]">
                <div className="p-8 md:p-12 lg:p-16">
                  ...
                  <div className="my-8 rounded-2xl p-8 border-2 border-dashed" style={{ backgroundColor: color2, borderColor: `${color1}66` }}>
          ...
          <section className="mb-24">
            <div className="max-w-7xl mx-auto">
              <Link to="/admissions" className="block">
                <div className="rounded-3xl p-10 shadow-xl border relative overflow-hidden group" style={{ backgroundColor: color1, borderColor: `${color1}CC` }}>
          ...
          <section className="mb-24">
            ...
            <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
              <div className="group relative bg-white rounded-3xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200 hover:-translate-y-2 overflow-hidden cursor-pointer" onMouseEnter={(e) => e.currentTarget.style.borderColor = `${color1}66`} onMouseLeave={(e) => e.currentTarget.style.borderColor = '#e5e7eb'}>
                ...
                <div className="relative">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-5 transition-colors duration-300" style={{ color: 'inherit' }} onMouseEnter={(e) => e.currentTarget.style.color = color1} onMouseLeave={(e) => e.currentTarget.style.color = 'inherit'}>
              ...
              <div className="group relative bg-white rounded-3xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200 hover:-translate-y-2 overflow-hidden cursor-pointer" onMouseEnter={(e) => e.currentTarget.style.borderColor = `${color1}66`} onMouseLeave={(e) => e.currentTarget.style.borderColor = '#e5e7eb'}>
                ...
                <div className="relative">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-5 transition-colors duration-300" onMouseEnter={(e) => e.currentTarget.style.color = color1} onMouseLeave={(e) => e.currentTarget.style.color = 'inherit'}>
          ...
          <section className="mb-24">
            <div className="max-w-7xl mx-auto">
              <div className="rounded-3xl p-10 md:p-16 shadow-xl overflow-hidden relative border hover:shadow-2xl transition-all duration-500 cursor-pointer" style={{ backgroundColor: color2, borderColor: `${color1}33` }} onMouseEnter={(e) => e.currentTarget.style.borderColor = `${color1}66`} onMouseLeave={(e) => e.currentTarget.style.borderColor = `${color1}33`}>
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {['British Council', 'UKIERI', 'Volkswagen Foundation', 'Toyota Foundation', 'Mozilla Foundation', 'MeitY', 'DST', 'DAAD & IGSTC'].map((org, i) => (
                      <div key={i} className="flex items-center gap-3 bg-white backdrop-blur-sm px-4 py-3 rounded-xl border hover:scale-105 transition-all duration-300 cursor-pointer shadow-sm" style={{ borderColor: `${color1}4D` }}>
              ...
              {researchGroups.map((group, index) => (
                ...
                >
                  ...
                  <div className="relative flex items-start gap-4">
                    <div className="flex-shrink-0 w-14 h-14 rounded-xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-300" style={{ backgroundColor: color2 }}>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {incubationCenters.map((center, index) => (
                  <div key={index} className="group relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-gray-200 cursor-pointer" onMouseEnter={(e) => e.currentTarget.style.borderColor = `${color1}66`} onMouseLeave={(e) => e.currentTarget.style.borderColor = '#e5e7eb'}>
                    ...
                    <div className="relative p-8">
                      <div className="w-20 h-20 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500" style={{ backgroundColor: color2 }}>
                        {center.icon}
                      </div>
                      <div className="text-sm font-bold mb-2 uppercase tracking-wide" style={{ color: color1 }}>{center.subtitle}</div>
                      <h3 className="text-2xl font-bold text-gray-900 mb-4 transition-colors duration-300" onMouseEnter={(e) => e.currentTarget.style.color = color1} onMouseLeave={(e) => e.currentTarget.style.color = 'inherit'}>
                        {center.title}
                      </h3>
              ...
              <div className="mt-12 rounded-2xl p-8 border-l-4 hover:shadow-lg transition-all duration-300 cursor-pointer" style={{ backgroundColor: color2, borderColor: color1 }}>
          ...
          <section className="mb-24">
            <div className="max-w-7xl mx-auto">
              <div className="rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-200" style={{ backgroundImage: `linear-gradient(to bottom right, ${color3}, ${color2}, ${color2})` }}>
                      ...
                      <div className="flex flex-wrap gap-3">
                        {['GeeksForGeeks', 'CodeChef', 'Google DSC', 'ACM Chapter', 'IEEE Student Branch'].map((club, i) => (
                          <span
                            ...
                            style={{ backgroundColor: color2, borderColor: `${color1}66`, color: color1 }}
                          >
                            {club}
                          </span>
                        ))}
          ...
          <section className="mb-24">
            <div className="max-w-7xl mx-auto">
              <div className="bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden hover:shadow-2xl transition-all duration-500 cursor-pointer hover:bg-[#e8f5f0]" onMouseEnter={(e) => e.currentTarget.style.borderColor = `${color1}66`} onMouseLeave={(e) => e.currentTarget.style.borderColor = '#e5e7eb'}>
                <div className="p-10 md:p-12">
                  ...
                  <div className="mt-8 rounded-2xl p-8 border-2 border-dashed" style={{ backgroundColor: color2, borderColor: `${color1}66` }}>
                    <div className="text-center">
          ...
          <section className="mb-24">
            <div className="max-w-7xl mx-auto">
              <div className="rounded-3xl shadow-xl border overflow-hidden hover:shadow-2xl transition-all duration-500 cursor-pointer" style={{ backgroundColor: color2, borderColor: `${color1}4D` }} onMouseEnter={(e) => e.currentTarget.style.borderColor = `${color1}99`} onMouseLeave={(e) => e.currentTarget.style.borderColor = `${color1}4D`}>
                <div className="p-10 md:p-12">
                  <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {['U. of Agder', 'TU Munich', 'U. North Dakota', 'Offenburg Univ.', 'U. Glasgow', 'U. Klagenfurt', 'Nat. Chung Cheng', 'Many More'].map((univ, i) => (
                      <div key={i} className="bg-white rounded-xl px-4 py-3 text-center border-2 hover:shadow-md transition-all duration-300 cursor-pointer" style={{ borderColor: `${color1}4D` }} onMouseEnter={(e) => e.currentTarget.style.borderColor = `${color1}99`} onMouseLeave={(e) => e.currentTarget.style.borderColor = `${color1}4D`}>
              ...
              <div className="rounded-3xl shadow-xl border overflow-hidden hover:shadow-2xl transition-all duration-500 cursor-pointer" style={{ backgroundColor: color2, borderColor: `${color1}4D` }} onMouseEnter={(e) => e.currentTarget.style.borderColor = `${color1}99`} onMouseLeave={(e) => e.currentTarget.style.borderColor = `${color1}4D`}>
                <div className="p-10 md:p-12">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                    <div className="bg-white rounded-2xl p-6 text-center border-2 shadow-md" style={{ borderColor: `${color1}66` }}>
